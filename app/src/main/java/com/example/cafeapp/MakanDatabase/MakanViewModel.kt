...
class MakanViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        ...
        makanDao = db.colorDao() // Pastikan ini mengarah ke MakanDAO
    ...
    fun getMakanById(id: Int): LiveData<Makan> {
        return makanDao.getMakanById(id) // Pastikan id bertipe Int
    }
    ...
    fun deleteMakanById(id: Int) { // Pastikan id bertipe Int
        viewModelScope.launch(Dispatchers.IO) {
